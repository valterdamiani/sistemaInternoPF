...
?>
        ...
        <div id="caixa-ranking" class="caixa-ranking float_left borderTL borderTR borderBL borderBR">
            ...
            <h3 class="h3_treinamento borderTL borderTR">Ranking</h3>
    ...
    foreach($valuesRanking as $linhaRanking) {
        ...
        echo "
                                <div class='divComentario'>
                                    <div class='apelidoRank'><p class='naMesmaLinha'>" . $posicao . "º - " . $apelido . "</p></div>&nbsp;&nbsp;
...
</html><?php header("Cache-Control: no-cache, must-revalidate"); 
