<?php header("Cache-Control: no-cache, must-revalidate"); 
    ...
    $pesq = $pdo->prepare("
        SELECT `id`, `dtmInicio`, `dtmFim`, `motivoContato`, `assunto`, `uf`, `cidade`, `bairro`, `tipoCliente`, `qtdPiscinas`, `volume`, `visitasSemanais`, `produtosInclusos`, `detalhes`, `statusDisputa`, `ganhador`, `statusConvercao`, `leads`.`id`, `solicitado`
        FROM `leads`
    ...
    foreach($valuesContratos as $linha) {
        ...
        echo "  
            <tr>
                ...
                <td style='vertical-align:middle'>" . utf8_encode ($dtmInicio) . "</td>
                <td style='text-align:middle; vertical-align:middle'>" . $assunto . "</td>
                <td style='text-align:middle; vertical-align:middle'>" . $uf . "</td>
                <td style='text-align:middle; vertical-align:middle'>" . $cidade . "</td>
                <td style='text-align:middle; vertical-align:middle'>" . $bairro . "</td>
                <td style='text-align:middle; vertical-align:middle'>" . $tipoCliente . "</td>
                <td style='text-align:middle; vertical-align:middle'>" . $qtdPiscinas . "</td>
                <td style='text-align:middle; vertical-align:middle'>" . $volume . "</td>
                <td style='text-align:middle; vertical-align:middle'>" . $produtosInclusos . "</td>";
